...
<div class="container">
    ...
    <form method="POST" action="{{ route('task.update', [$task])}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('task_title') is-invalid @enderror" type='text' name='task_title' value="{{$task->title}}" />
            @error('task_title')
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('task_startDate') is-invalid @enderror" type='date' name='task_startDate' value="{{$task->start_date}}" />
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('task_endDate') is-invalid @enderror" type='date' name='task_endDate' value="{{$task->end_date}}" />
            @error('task_endDate')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
